...
export const translations = {
  fr: {
    ...
    pricing: {
      ...
      quoteText:  'Vidéo plus longue que 15s, série de clips, format spécifique ou volume pour une campagne — décrivez votre besoin, on revient vers vous avec un devis sous 4h ouvrées.',
  ...
  en: {
    ...
    pricing: {
      ...
      quoteText:  'A longer video than 15s, a series of clips, a specific format or campaign volume — describe your need and we\'ll get back to you with a quote within 4 business hours.',
