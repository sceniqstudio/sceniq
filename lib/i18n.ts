...
export const translations = {
  fr: {
    ...
    // ── Stats ────────────────────────────────────────────────────────────────
    stats: [
      { num: '48h',  label: 'Délai de livraison garanti' },
      { num: '10×',  label: 'Itérations incluses' },
      { num: '3+',   label: 'Formats livrés simultanément' },
      { num: '5↗',   label: 'Agents IA en parallèle' },
    ],
  ...
  en: {
    ...
    stats: [
      { num: '48h', label: 'Guaranteed delivery time' },
      { num: '10×', label: 'Revisions included' },
      { num: '3+',  label: 'Formats delivered at once' },
      { num: '5↗',  label: 'AI agents in parallel' },
    ],
