...
export const translations = {
  fr: {
    ...
    hero: {
      ...
      h1b:      'en vidéo. En 48h.',
      sub:      'Décrivez ce que vous imaginez — une ambiance, une scène, une marque. En 48h, c\'est un clip 1080p prêt à diffuser. Zéro réunion. Zéro agence.',
    ...
    portfolio: {
      ...
      h2b:      'Seedance 2.0',
      sub:      'Mode, food, tech, gaming, luxe, B2B. Tout ce que vous pouvez imaginer — produit en 48h.',
  ...
  en: {
    ...
    hero: {
      ...
      sub:      'Describe what you have in mind — a mood, a scene, a brand. In 48h, it\'s a 1080p clip ready to publish. No meetings. No agency.',
      cta1:     'Order my video →',
      cta2:     'See the work',
    ...
    portfolio: {
      ...
      h2b:    'Seedance 2.0',
      sub:    'Fashion, food, tech, gaming, luxury, B2B. Everything you can imagine — produced in 48h.',
      hint:   'Drag or swipe',
