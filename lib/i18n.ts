...
export const translations = {
  fr: {
    ...
    caseStudy: {
      ...
      sectionIntro: 'Le studio où on produit vos vidéos, de l\'idée au livrable. Trois entrées : un cas concret, l\'équipe créa, le moteur de génération.',
    ...
    pricing: {
      ...
      sub:         'Un brief. Un prix. Ce que vous commandez, c\'est ce que vous recevez — pas d\'abonnement, pas de crédits, pas d\'interface à apprivoiser. Le tarif dépend d\'une seule chose : la durée de votre vidéo (5 à 60 secondes).',
      ...
      plans: [
        { dur: '5 sec',  fmt: 'Format court',        price: 69,  modelPrice: 49,  shots: 2, voix: false, featured: false },
        { dur: '10 sec', fmt: 'Format pub',          price: 109, modelPrice: 49,  shots: 3, voix: true,  featured: true,  anchor: 'Agence : 500–1 500 € pour ce format'  },
        { dur: '15 sec', fmt: 'Format histoire',     price: 159, modelPrice: 49,  shots: 4, voix: true,  featured: false, anchor: 'Agence : 800–2 000 € pour ce format'   },
        { dur: '30 sec', fmt: 'Format campagne',     price: 249, modelPrice: 99,  shots: 6, voix: true,  featured: false, anchor: 'Agence : 1 500–4 000 € pour ce format' },
        { dur: '60 sec', fmt: 'Format présentation', price: 449, modelPrice: 149, shots: 8, voix: true,  featured: false, anchor: 'Agence : 3 000–8 000 € pour ce format' },
      ],
      perks: {
      ...
      quoteText:  'Vidéo plus longue que 60s, série de clips, abonnement mensuel ou volume pour une campagne — décrivez votre besoin, on revient vers vous avec un devis sous 4h ouvrées.',
    ...
    faq: {
      ...
      right: [
        ...
        { q: 'Quelle durée choisir pour ma publicité ?',                a: '5s pour une accroche Reel ou Story. 10s pour une pub Meta classique avec voix-off courte. 15s pour du storytelling ou une démonstration produit. 30s pour une campagne marque avec narration complète. 60s pour une présentation produit détaillée, un explainer ou un format LinkedIn/YouTube. En cas de doute, le 10s est le plus polyvalent pour les Ads.' },
    ...
    modal: {
      ...
      h3:          'Une question ?',
      sub:         'Pas encore prêt(e) à commander ? Posez-nous votre question directement — vous parlez à une vraie personne, pas à un bot.',
      ...
      sentSub:     'On vous répond personnellement sous 4h ouvrées. Si c\'est urgent, appelez directement.',
      sentClose:   'Fermer',
    },
    ...
    promoModal: {
      ...
      sub:          'Décrivez votre vidéo en deux lignes. On génère un reel 8s sur votre cas concret, gratuitement. Vous voyez le résultat avant de vous engager.',
      labelName:    'Prénom',
      placeName:    'Marie',
      labelEmail:   'Email',
      ...
      sentSub:      'On lance la génération personnellement. Votre reel 8s vous sera envoyé sous 48h ouvrées — directement par email.',
      sentClose:    'Fermer',
    },
    ...
    checkout: {
      ...
      durLabels:  { 5:'Court', 8:'Reel', 10:'Pub', 12:'Narration', 15:'Histoire', 30:'Campagne', 60:'Présentation' } as Record<number,string>,
      ...
      s1: {
        ...
        sub:        'Marque, ton, message, contexte. On s\'occupe du reste.',
        briefLabel: 'Brief',
  ...
  en: {
    ...
    caseStudy: {
      ...
      sectionIntro: 'The studio where we produce your videos, from idea to delivery. Three ways in: a real case, the creative team, the generation engine.',
      ...
      body2:   'With ScenIQ, the product goes into the AI Studio and we handle everything end to end: concept, staging, lighting, shots. You get a ready-to-publish video, your product front and center and in context, with no meetings and no team to manage.',
    ...
    pricing: {
      ...
      sub:         'One brief. One price. What you order is what you get — no subscription, no credits, no interface to figure out. The price depends on one thing only: the duration of your video (5 to 60 seconds).',
      ...
      plans: [
        { dur: '5 sec',  fmt: 'Short format',        price: 69,  modelPrice: 49,  shots: 2, voix: false, featured: false },
        { dur: '10 sec', fmt: 'Ad format',           price: 109, modelPrice: 49,  shots: 3, voix: true,  featured: true,  anchor: 'Agency: €500–1,500 for this format'  },
        { dur: '15 sec', fmt: 'Story format',        price: 159, modelPrice: 49,  shots: 4, voix: true,  featured: false, anchor: 'Agency: €800–2,000 for this format'   },
        { dur: '30 sec', fmt: 'Campaign format',     price: 249, modelPrice: 99,  shots: 6, voix: true,  featured: false, anchor: 'Agency: €1,500–4,000 for this format' },
        { dur: '60 sec', fmt: 'Presentation format', price: 449, modelPrice: 149, shots: 8, voix: true,  featured: false, anchor: 'Agency: €3,000–8,000 for this format' },
      ],
      perks: {
      ...
      quoteText:  'A video longer than 60s, a series of clips, a monthly subscription or campaign volume — describe your need and we\'ll get back to you with a quote within 4 business hours.',
    ...
    faq: {
      ...
      right: [
        ...
        { q: 'Which duration should I choose?',                          a: '5s for a Reel or Story hook. 10s for a standard Meta ad with a short voice-over. 15s for storytelling or a product demo. 30s for a brand campaign with full narration. 60s for a detailed product presentation, explainer or LinkedIn/YouTube format. When in doubt, 10s is the most versatile for Ads.' },
    ...
    modal: {
      ...
      h3:          'Got a question?',
      sub:         'Not quite ready to order? Ask us directly — you\'re talking to a real person, not a bot.',
      ...
      sentSub:     'We\'ll get back to you personally within 4 business hours. If it\'s urgent, call directly.',
      sentClose:   'Close',
    },
    ...
    promoModal: {
      ...
      sub:          'Describe your video in two lines. We\'ll generate a free 8s reel on your actual brief. See the result before you commit.',
      labelName:    'First name',
      placeName:    'Alex',
      labelEmail:   'Email',
      ...
      sentSub:      'We\'re generating it personally. Your 8s reel will be sent to you within 48 business hours — straight to your inbox.',
      sentClose:    'Close',
    },
    ...
    checkout: {
      ...
      durLabels:  { 5:'Short', 8:'Reel', 10:'Ad', 12:'Narration', 15:'Story', 30:'Campaign', 60:'Presentation' } as Record<number,string>,
