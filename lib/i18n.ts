...
export const translations = {
  fr: {
    ...
    models: {
      ...
      kaelysPartnerNote:'Kaelys n\'est pas un personnage jetable — elle a une présence Instagram réelle. Elle peut représenter votre marque en continu : intégrée à vos clips, vos stories, vos campagnes. Tarif sur devis.',
  ...
  en: {
    ...
    models: {
      ...
      kaelysIG:         'https://www.instagram.com/bymivael/',
      kaelysHandle:     '@bymivael',
      kaelysPartnerNote:'Kaelys isn\'t a throwaway character — she has a real Instagram presence. She can represent your brand consistently: integrated into your clips, stories, and campaigns. Custom pricing on request.',
