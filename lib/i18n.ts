...
export const translations = {
  fr: {
    ...
    pricing: {
      ...
      sub:         'Choisissez la durée. Chaque forfait inclut la production complète — script, storyboard, musique et montage final MP4 1080p. Livraison sous 48h ouvrées.',
  ...
  en: {
    ...
    pricing: {
      ...
      sub:         'Choose your duration. Every package includes the complete production — script, storyboard, music and final 1080p MP4. Delivered within 48 working hours.',
