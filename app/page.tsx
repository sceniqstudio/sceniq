...
const TICKER_FR = [
  'Un robot humanoïde dans New York',
  'Un lancement de casque audio haut de gamme',
  'Un clip gaming post-apocalyptique',
  'Un film de mode haute couture',
  'Un spot B2B pour un chargeur électrique',
  'Un teaser automobile dans un parking sombre',
  'Un unboxing collector édition limitée',
  'Une pub food avec épices en slow-motion',
  'Un reel sport pour une marque de vélo',
  'Une campagne fitness avec comédienne IA',
  'Un clip café artisanal grain par grain',
  'Une mascotte 3D CGI pour un jeu mobile',
  'Un film lifestyle édito minimaliste',
]
const TICKER_EN = [
  'A humanoid robot in New York',
  'A premium headphone launch film',
  'A post-apocalyptic gaming clip',
  'A haute couture fashion film',
  'A B2B spot for an EV charger',
  'A luxury car reveal in a parking garage',
  'A limited-edition collector unboxing',
  'A slow-motion spice food ad',
  'A sport reel for a cycling brand',
  'A fitness campaign with an AI performer',
  'An artisan coffee clip shot by shot',
  'A 3D CGI mascot for a mobile game',
  'A minimalist lifestyle editorial',
]
